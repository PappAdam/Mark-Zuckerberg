...
})({"bAoJx":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "10308e890812e162";
...
if (pageAccessedByReload === true) window.location.replace("http://localhost:1234/index.html");
const H = new (0, _highwayDefault.default).Core({
    transitions: {
        default: (0, _defaultJsDefault.default),
        contextual: {
            swipe_r: (0, _swipeJs.SwipeRight),
            swipe_l: (0, _swipeJs.SwipeLeft)
        }
    }
});

},{"./transitions/default.js":"c0xj5","@dogstudio/highway":"26LRT","./transitions/swipe.js":"bXvtc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"c0xj5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
// Fade
class placehodler extends (0, _highwayDefault.default).Transition {
    in({ from , to , done  }) {
        // Reset Scroll
        window.scrollTo(0, 0);
        // Remove Old View
        from.remove();
        // Animation
        (0, _gsapDefault.default).fromTo(to, 0.5, {
            opacity: 0
        }, {
            opacity: 1,
            onComplete: done
    ...
    out({ from , done  }) {
        // Animation
        (0, _gsapDefault.default).fromTo(from, 0.5, {
            opacity: 1
        }, {
            opacity: 0,
            onComplete: done
...
exports.default = placehodler;

},{"@dogstudio/highway":"26LRT","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"26LRT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function t() {}
t.prototype = {
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bXvtc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SwipeRight", ()=>SwipeRight);
parcelHelpers.export(exports, "SwipeLeft", ()=>SwipeLeft);
var _highway = require("@dogstudio/highway");
var _highwayDefault = parcelHelpers.interopDefault(_highway);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
var _positionJs = require(".././navbar/position.js");
class SwipeRight extends (0, _highwayDefault.default).Transition {
    in({ from , to , done  }) {
        window.scrollTo(0, 0);
...
class SwipeLeft extends (0, _highwayDefault.default).Transition {
    in({ from , to , done  }) {
        window.scrollTo(0, 0);
        (0, _gsapDefault.default).fromTo(from, {
            right: "0%"
